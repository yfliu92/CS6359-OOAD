      ...
      <div class="row">
       <%@ include file = "./app/shared/sidebar/sidebar.jsp" %>
        <div class="col-md-10 page-content-container">
			...
			<br>Time: <input type="text" name = "stime" style="width: 60px"><select name="ap1"><option value="am">AM</option><option value="pm">PM</option></select>
			 to 
			 <input type="text" name = "etime" style="width: 60px"><select name="ap2"><option value="am">AM</option><option value="pm">PM</option></select>  #format as 08:30
