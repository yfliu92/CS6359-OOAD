    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 page-content-container">
                ...
                <button class="btn btn-primary" type="button" value="Add User" onclick="showAdd()">Add User</button>
                <div id="adiv" class="addForm" style="display:none">
                    <form name="addform" method=post action="AddUserController">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="fname" class="form-control" id="inputFistName" placeholder="First name">
                            </div>
                            <div class="form-group col-md-6">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="<%= basePath %>app/js/user.js"></script>
</body>
</html>